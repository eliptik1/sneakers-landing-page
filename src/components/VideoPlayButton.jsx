export default function VideoPlayButton() {
  return (
    <svg
      className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 hover:cursor-pointer group hover:scale-105 transition-all "
      width="144"
      height="145"
      viewBox="0 0 144 145"
      fill="none"
    ...
    >
      ...
      />
      <path
        className="group-hover:fill-yellow-200"
